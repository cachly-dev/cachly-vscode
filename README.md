...
![The Lessons view inside VS Code, listing stored lessons such as cache:stampede and git:force-push-safety across the full width of the panel](https://cachly.dev/screenshots/vscode/shot3-lesson-card.png)
